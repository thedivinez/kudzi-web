...
const Contact = () => {
    return (
        <section id="contact" className="flex flex-col justify-center mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full max-w-7xl">
            ...
            <div className="gap-12 grid md:grid-cols-2">
                ...
                {/* Contact Form */}
                <SpotlightCard
                    className={`flex flex-col space-y-3 bg-slate-800/55  transform transition-all duration-700 delay-300 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20`}
                    data-animate
                >
                    ...
                    <div>
                        <form className="space-y-4">
                            <div>
                                ...
                                <input
                                    type="text"
                                    className="bg-slate-700/30 px-3 py-2 border border-slate-600 hover:border-cyan-500 focus:border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-400 w-full text-white transition-all duration-300"
